...
const Header = () => {
  ...
  return (
    <div className="absolute w-screen px-8 py-2 bg-gradient-to-b from-black z-10 flex flex-col md:flex-row justify-between">
     ...
     {isgpt&&<select className="w-20 h-9 bg-pink-400 rounded-sm text-white" onChange={(e)=>{
    ...
    {isgpt?"Home Page":"GPT Search"}
        ...
        {/* <button onClick={(e)=>changeContextName(true)} className="bg-green-500 h-9 mx-4 px-3 rounded-sm text-white">GPT Search</button> */}
        <img
